...
import validationSchema from 'components/User/PasswordChange/components/PasswordChangeForm/schema/index';
// the hoc
...
export class PasswordChangeForm extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="w-50 shadow-lg p-5 bg-white rounded">
